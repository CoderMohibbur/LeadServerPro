                                ...
                                <table id="dataTable" class="table-auto w-full border-collapse dark:border-gray-700">
                                    <thead class="bg-gray-200">
                                        <tr>
                                            ...
                                            <th class="px-4 py-2 border dark:border-gray-600 text-blue-800 dark:text-blue-400 font-bold text-center"> Sheet ID</th>
