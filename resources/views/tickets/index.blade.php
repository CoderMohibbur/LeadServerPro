            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse border border-gray-200 dark:border-gray-700">
                    <thead class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                        <tr>
                            <th class="py-3 px-6 text-sm font-semibold border border-gray-200 dark:border-gray-700">
                                Title</th>
                            <th class="py-3 px-6 text-sm font-semibold border border-gray-200 dark:border-gray-700">
                                Status</th>
                            <th class="py-3 px-6 text-sm font-semibold border border-gray-200 dark:border-gray-700">
                    ...
                    <tbody class="text-gray-800 dark:text-gray-200">
                        @forelse ($tickets as $ticket)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td class="py-3 px-6 border border-gray-200 dark:border-gray-700">{{ $ticket->title }}
                                </td>
                                ...
                                <td class="py-3 px-6 border border-gray-200 dark:border-gray-700">
                                    ...
                                    @if (auth()->user()->hasRole('admin|manager'))
                                        <a href="{{ route('tickets.answer', $ticket->id) }}"
                                            class="text-green-500 hover:text-green-700">Answer</a>
                                    @else
                                        <a href="{{ route('client.tickets.answer', $ticket->id) }}"
                                            class="text-green-500 hover:text-green-700">Answer</a>
                                    @endif
                        ...
                        @empty
                            <tr>
                                <td colspan="4"
                                    class="py-3 px-6 text-center border border-gray-200 dark:border-gray-700">No tickets
                                    found.</td>
                            </tr>
                        @endforelse
                    </tbody>
